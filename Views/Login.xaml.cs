...
namespace Project.Views
{
    ...
    public partial class Login : ContentPage
    {
        ...
        {
            OlvContra forget = new OlvContra();
            await Navigation.PushAsync(forget);
        }
			...
			try
			{
				...
				if (response.IsSuccessStatusCode)
				{
					...
					if (result != null && result.message == "Login exitoso" && result.usuario != null)
					{
						...
						Preferences.Set("UserId", result.usuario.Id);
						Preferences.Set("UserName", result.usuario.NombreUsuario);
						Preferences.Set("UserEmail", result.usuario.Email);
